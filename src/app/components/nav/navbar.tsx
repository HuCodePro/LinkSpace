        ...
        <nav className={`bg-white md:text-sm shadow-3xl ${state ? "shadow-2xl rounded-xl border mx-2 mt-2 md:shadow-none md:border-none md:mx-2 md:mt-0" : ""}`}>
            <div className="gap-x-14 ml-40 items-center width-full mx-auto px-4 md:flex md:px-8">
                ...
                <div className="flex-1 gap-x-6 items-center justify-end mt-6 space-y-6 md:flex md:space-y-0 md:mt-0">
                    <a href="javascript:void(0)" className="block text-gray-700 hover:text-blue-600">
                        Se connecter
                    </a>
                    <a href="javascript:void(0)" className="flex items-center justify-center gap-x-1 py-2 px-4 text-white font-medium bg-blue-800 hover:bg-blue-600 active:bg-gray-900 rounded-full md:inline-flex">
                        Sinscrire
